...
{
    public class CheckDigitsFieldValidatorTests
    {
        [Theory,
         InlineData("40", null),
         InlineData("4", "Contains no padding zeroes")]
        public void IsValid_in_scenario(string input, string expectedMessage)
        {
            var sut = new CheckDigitsFieldValidator();
        ...
        [Theory,
         ...
         InlineData("  ", "Cannot be empty or white space"),
         InlineData("040", "Cannot be larger than two characters"),
         InlineData("89533311", "Cannot be larger than two characters"),
         InlineData("4Z", "Cannot consist of anything other than digits ranging from 0 to 9")]
